...
![hosted zone](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/hosted-zone.png)

2. Tạo 1 record mới trong Private Hosted Zone:

![Create record](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/create-record1.png)
...
![record1](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/record1.png)
...
![record 2](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/record2.png)

Record mới xuất hiện trên giao diện Route 53.

![result](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/result.png)
...
![Inbound endpoint](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/route53-1.png)

3. Sao chép 2 địa chỉ IP trong danh sách vào trình chỉnh sửa.

![Ip addresses](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/route53-2.png)

4. Từ giao diện Route 53, chọn  **Resolver** > **Rules** và chọn **Create rule**

![Ip addresses](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/route53-3.png)
...
![create rule](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/route53-4.png)

+ VPC: VPC On-prem
+ Outbound endpoint: VPCOnpremOutboundEndpoint

![create rule](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/route53-5.png)

+ Target IP Addresses: điền cả hai IP bạn đã lưu trữ trên trình soạn thảo (inbound endpoint addresses) và sau đó chọn **Submit**

![create rule](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/route53-6.png)

Bạn đã tạo thành công resolver forwarding rule. 

![create rule](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/route53-7.png)

#### Kiểm tra on-premises DNS mô phỏng.

1. Kết nối đến **Test-Interface-Endpoint EC2 instance** với **Session Manager**

![create rule](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/test1.png)
...
![create rule](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/dig.png)
...
![create rule](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/subnet.png)
...
![create rule](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/endpoint.png)

5. Kết thúc phiên làm việc của Session Manager của bạn:

![create rule](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/terminal.png)
