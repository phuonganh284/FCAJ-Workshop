...
![Create bucket](/FCAJ-Workshop/images/5-Workshop/5.3-S3-vpc/create-bucket.png)
...
![Bucket name](/FCAJ-Workshop/images/5-Workshop/5.3-S3-vpc/bucket-name.png)

+ Leave other fields as they are (default)
+ Scroll down and choose **Create bucket**

![Create](/FCAJ-Workshop/images/5-Workshop/5.3-S3-vpc/create-button.png) 

+ Successfully create S3 bucket.

![Success](/FCAJ-Workshop/images/5-Workshop/5.3-S3-vpc/bucket-success.png)
...
![system manager](/FCAJ-Workshop/images/5-Workshop/5.3-S3-vpc/sm.png)

2. From the **Systems Manager** menu, find **Node Management** in the left menu and click **Session Manager**:

![system manager](/FCAJ-Workshop/images/5-Workshop/5.3-S3-vpc/sm1.png)
...
![Start session](/FCAJ-Workshop/images/5-Workshop/5.3-S3-vpc/start-session.png)

**Session Manager** will open a new browser tab with a shell prompt: sh-4.2 $

![Success](/FCAJ-Workshop/images/5-Workshop/5.3-S3-vpc/start-session-success.png)
...
![Change user's dir](/FCAJ-Workshop/images/5-Workshop/5.3-S3-vpc/cli1.png)
...
![Create file](/FCAJ-Workshop/images/5-Workshop/5.3-S3-vpc/cli-file.png)
...
![Uploaded](/FCAJ-Workshop/images/5-Workshop/5.3-S3-vpc/uploaded.png)
...
![Check S3](/FCAJ-Workshop/images/5-Workshop/5.3-S3-vpc/check-s3-bucket.png)
