...
![route 53 diagram](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/route53.png)
...
![Create stack](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/create-stack.png)

![Button](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/create-stack-button.png)
...
![ec2 id](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/ec2-onprem-id.png)
...
![rt](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/rt.png)

5. Click Add route.
+ Destination: CIDR block của Cloud VPC
+ Target: ID của infra-vpngw-test instance (bạn đã lưu lại ở bước trên)

![add route](/FCAJ-Workshop/images/5-Workshop/5.4-S3-onprem/add-route.png)
