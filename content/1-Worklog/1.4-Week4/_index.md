...
* Explore serverless computing using AWS Lambda.
* Configure REST APIs with API Gateway.
...
* Created serverless functions using Lambda.
* Tested Lambda execution successfully.
* Configured REST APIs using API Gateway.
