...
* Learn and configure Identity and Access Management (IAM).
...
* Understood AWS global architecture.
* Learned IAM authentication and authorization concepts.
* Successfully created IAM users, groups, and roles.
* Configured permission policies using least privilege.
* Enabled MFA to improve account security.