...
* Hiểu tổng quan về kiến trúc AWS.
* Tìm hiểu và cấu hình dịch vụ Identity and Access Management (IAM).
...
* Hiểu được kiến trúc hạ tầng toàn cầu của AWS.
* Nắm được cơ chế xác thực và phân quyền của IAM.
* Tạo thành công IAM User, Group và Role.
* Cấu hình Policy theo nguyên tắc phân quyền tối thiểu (Least Privilege).
* Bật xác thực đa yếu tố (MFA) nhằm tăng cường bảo mật cho tài khoản AWS.